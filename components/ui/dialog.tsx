...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 grid w-full gap-4 border bg-background p-6 shadow-lg animate-fade-in',
        // Full-screen sheet on mobile, centred dialog from sm up.
        'inset-0 h-full max-h-full overflow-y-auto rounded-none',
        'sm:inset-auto sm:left-1/2 sm:top-1/2 sm:h-auto sm:max-h-[90vh] sm:max-w-lg',
